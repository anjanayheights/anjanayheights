...
export default function RevenueCommissionSummary() {
  ...
  return <section className="max-w-7xl mx-auto px-4 md:px-8 pt-5"><div className="rounded-2xl border bg-white p-4 shadow-sm">
    <div className="flex flex-wrap items-center justify-between gap-2 mb-3"><div><h2 className="text-lg font-bold text-[#1A365D]">💰 Sales, Revenue & Commission Intelligence</h2><p className="text-sm text-gray-500">Live funnel, pipeline value and closed-deal brokerage from CRM data.</p></div><button onClick={() => window.location.reload()} className="border rounded-lg px-3 py-2 text-sm font-semibold">Refresh</button></div>
