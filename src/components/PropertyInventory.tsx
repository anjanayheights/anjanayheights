...
export default function PropertyInventory() {
  ...
  const filtered = useMemo(() => properties.filter(p => `${p.title} ${p.propertyType} ${p.location} ${p.price}`.toLowerCase().includes(search.toLowerCase())), [properties, search]);
