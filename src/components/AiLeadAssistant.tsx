...
export default function AiLeadAssistant() {
  ...
  const modeButton = (nextMode: Mode) => (e: React.PointerEvent<HTMLButtonElement>) => {
    e.preventDefault();
    if (!loading) setMode(nextMode);
  };
