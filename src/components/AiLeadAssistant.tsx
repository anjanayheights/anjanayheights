...
export default function AiLeadAssistant() {
  ...
  async function checkPassword() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Unable to verify dashboard password.');
  ...
  async function runAssistant() {
    ...
    try {
      ...
      const leadsData = await readJson(lr);
      const propertiesData = await readJson(pr);
      const metaData = await readJson(mr);
      ...
      setError(err instanceof Error ? err.message : 'Something went wrong while running AI.');
    } finally { setLoading(false); setStage('idle'); }
  }
